...
Application is live: senti-product-recommendation.herokuapp.com
...
Colloborative Filtering Recommender system is created based on User-user and item-item approaches.RMSE evaluation metrics is used for the evaluation
...
Machine Learning models are saved in pickle files; Flask API is used to interface and test the Machine Learning models. Bootstrap and Flask jinja templates are used for setting up the User interface.
